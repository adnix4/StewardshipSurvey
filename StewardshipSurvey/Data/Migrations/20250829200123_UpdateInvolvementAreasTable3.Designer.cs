...
namespace StewardshipSurvey.Data.Migrations
{
    ...
    [Migration("20250829200123_UpdateInvolvementAreasTable3")]
    partial class UpdateInvolvementAreasTable3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StewardshipSurvey.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("StewardshipSurvey.Models.InterestsAreas", b =>
                {
            ...
            modelBuilder.Entity("StewardshipSurvey.Models.InvolvementAreas", b =>
                {
            ...
            modelBuilder.Entity("StewardshipSurvey.Models.MemberInfo", b =>
                {
                    b.Property<int>("MemberID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StewardshipSurvey.Models.MemberInterest", b =>
                {
                    b.Property<int>("MemberID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StewardshipSurvey.Models.MemberInvolvement", b =>
                {
                    b.Property<int>("MemberID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StewardshipSurvey.Models.MemberServiceRole", b =>
                {
                    b.Property<int>("MemberID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StewardshipSurvey.Models.ServiceRoles", b =>
                {
                    b.Property<int>("ServiceRoleID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StewardshipSurvey.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StewardshipSurvey.Data.ApplicationUser", b =>
                {
                    b.HasOne("StewardshipSurvey.Models.MemberInfo", "Member")
                        .WithOne("ApplicationUser")
                        .HasForeignKey("StewardshipSurvey.Data.ApplicationUser", "MemberID");
            ...
            modelBuilder.Entity("StewardshipSurvey.Models.MemberInterest", b =>
                {
                    b.HasOne("StewardshipSurvey.Models.InterestsAreas", "InterestArea")
                    ...
                    b.HasOne("StewardshipSurvey.Models.MemberInterest", null)
                        .WithMany("MemberInterests")
            ...
            modelBuilder.Entity("StewardshipSurvey.Models.MemberInvolvement", b =>
                {
                    b.HasOne("StewardshipSurvey.Models.InvolvementAreas", "InvolvementArea")
                    ...
                    b.HasOne("StewardshipSurvey.Models.MemberInvolvement", null)
                        .WithMany("MemberInvolvements")
            ...
            modelBuilder.Entity("StewardshipSurvey.Models.MemberServiceRole", b =>
                {
                    ...
                    b.HasOne("StewardshipSurvey.Models.ServiceRoles", "ServiceRole")
                        .WithMany("MemberServiceRoles")
                        .HasForeignKey("ServiceRoleID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StewardshipSurvey.Models.MemberServiceRole", null)
                        .WithMany("MemberServiceRoles")
